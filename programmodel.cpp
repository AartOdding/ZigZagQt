...
void ProgramModel::remove_operator_undoable(QPointer<BaseTOP> operator_)
{
...
void ProgramModel::connect_operators_undoable(QPointer<BaseTOP> operator_a, QPointer<BaseTOP> operator_b, int b_input)
{

}


void ProgramModel::disconnect_operators_undoable(QPointer<BaseTOP> operator_a, QPointer<BaseTOP> operator_b, int b_input)
{
...
void ProgramModel::add_operator(const QString& operator_class, int x, int y, qint64 id)
{
    ...
    {
        QPointer<BaseTOP> new_operator = new ShaderTOP(*this);
...
QList<BaseTOP*> ProgramModel::get_entry_nodes()
{
    auto all_children = findChildren<BaseTOP*>();
    QList<BaseTOP*> entry_points;
...
QList<BaseTOP*> ProgramModel::get_all_nodes()
{
    return findChildren<BaseTOP*>();
}
