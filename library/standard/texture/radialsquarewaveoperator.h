...
class RadialSquareWaveOperator : public BaseOperator,
                                 public QOpenGLFunctions_3_3_Core
{

public:

    RadialSquareWaveOperator();

    void run() override;

    static BaseOperator * create() { return new RadialSquareWaveOperator(); }

    void parameter_changed(BaseParameter* parameter) override;


    static const inline OperatorTypeInfo Type { "Radial Square Wave", "Video Synthesis", {  },
