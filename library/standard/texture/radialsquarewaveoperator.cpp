#include "radialsquarewaveoperator.h"
...
bool RadialSquareWaveOperator::gpu_resources_initialized = false;
QOpenGLShaderProgram RadialSquareWaveOperator::shader;
GLuint RadialSquareWaveOperator::vao;
GLuint RadialSquareWaveOperator::vbo;
...
RadialSquareWaveOperator::RadialSquareWaveOperator()
    : BaseOperator(Type)
{
...
void RadialSquareWaveOperator::run()
{
    ...
    if (should_update)
    {
        ...
        shader.setUniformValue(shader.uniformLocation("duty_cycle"), static_cast<float>(duty_cycle.get()));
...
void RadialSquareWaveOperator::parameter_changed(BaseParameter* parameter)
{
    should_update = true;
}
