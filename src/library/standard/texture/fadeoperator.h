...
private:
    ...
    DataInput texture_0{ this, "Input 0", TextureData::description };
    DataInput texture_1{ this, "Input 1", TextureData::description };
    DataInput texture_2{ this, "Input 2", TextureData::description };
    DataInput texture_3{ this, "Input 3", TextureData::description };
    DataInput texture_4{ this, "Input 4", TextureData::description };
