    ...
    : QSpinBox(parent), parameter(par)
{
    ...
    connect(parameter, qOverload<int64_t>(&BaseComponent::valueChanged), this, &Int64ParameterBox::on_parameterChangeEvent);

    connect(parameter, &BaseComponent::flagChanged, this, &Int64ParameterBox::onFlagsChanged);
...
void Int64ParameterBox::on_parameterChangeEvent(int64_t new_value)
{
...
void Int64ParameterBox::onFlagsChanged(ParameterFlags flag, bool value)
{
